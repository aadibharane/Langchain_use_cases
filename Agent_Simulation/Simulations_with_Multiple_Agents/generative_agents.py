...
#This notebook implements a generative agent based on the paper Generative Agents: 
#Interactive Simulacra of Human Behavior by Park, et. al.
...
'''
This tutorial highlights the memory of generative agents and its impact on their behavior. 
The memory varies from standard LangChain Chat memory in two aspects:
1.Memory Formation
...
#You can review the definitions of the GenerativeAgent and GenerativeAgentMemory in the reference documentation 
#for the following imports, focusing on add_memory and summarize_related_memories methods.
...
def generative_agents():
    ...
    res=interview_agent(tommie, "What do you like to do?")
    #res=interview_agent(tommie, "What are you looking forward to doing today?")
    #res=interview_agent(tommie, "What are you most worried about today?")
    print(res)
    ...
    #res=interview_agent(tommie, "Tell me about how your day has been going")
    #res=interview_agent(tommie, "How do you feel about coffee?")
    res=interview_agent(tommie, "Tell me about your childhood dog!")
    print(res)
    ...
    res=interview_agent(eve, "How are you feeling about today?")
    ...
    agents = [tommie, eve]
    res=run_conversation(agents, "Tommie said: Hi, Eve. Thanks for agreeing to meet with me today. I have a bunch of questions and am not sure where to start. Maybe you could first share about your experience?")
    print(res)
    ...
    res=interview_agent(tommie, "How was your conversation with Eve?")
